...
> 全平台视频下载 + AI 笔记。支持 10+ 平台，一键生成章节大纲、核心摘要、思维导图和智能问答。

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Python 3.10+](https://img.shields.io/badge/python-3.10+-blue.svg)](https://www.python.org/)
[![Vue 3](https://img.shields.io/badge/Vue-3-42b883.svg)](https://vuejs.org/)
[![Platforms](https://img.shields.io/badge/platforms-10-orange.svg)](#supported-platforms)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](CONTRIBUTING.md)

<!-- TODO: Replace with real screenshot -->
![Screenshot](docs/screenshot.png)

**VidMemo** lets you paste a video URL, preview it in-browser, pick a quality (360p–4K), and download with no watermark. AI-powered features include chapter outlines, executive summaries, mindmaps, and chat-with-video Q&A — all streamed via SSE with 30-day caching. Supports 10 platforms, with platform-specific workarounds for B站 1080P unlock, 抖音 anti-bot bypass, and GFW-friendly proxy routing.

---

## Features

- **10 platforms** — YouTube, Bilibili, Instagram, TikTok, 抖音, 小红书, 微博, X (Twitter), Facebook, 西瓜视频
...
- **Mindmap** — hierarchical mindmap generated by LLM, click nodes to seek video
- **Chat with Video** — ask questions about video content, AI answers with chapter-level citations
- **Content export** — copy/download summary as Markdown, subtitles as TXT/SRT
...
```bash
# 1. Clone
git clone https://github.com/SAX-ops/VidMemo.git
cd VidMemo
...
| `POST` | `/api/summarize` | SSE stream of AI video summary (outline + executive summary + mindmap, with 30-day cache) |
| `POST` | `/api/chat` | SSE stream of Chat with Video Q&A (chapter-level citations) |
...
VidMemo（影记）是一款全平台视频下载 + AI 笔记工具，支持 YouTube、Bilibili、Instagram、TikTok、抖音、小红书、微博、X、Facebook、西瓜视频共 10 个平台。核心特性：
...
- **AI 视频总结** — 两阶段 LLM 流水线：章节大纲 + 视频概述 + 思维导图，SSE 流式输出，30 天文件缓存
- **AI 智能问答** — 基于视频内容的问答，章节级引用，逐 token 流式输出
- **内容导出** — 复制/下载总结为 Markdown，字幕为 TXT/SRT
